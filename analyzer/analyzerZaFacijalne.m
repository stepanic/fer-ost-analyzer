...
tran_neutral1_poduzorkovan = downsample(tran_neutral1, 10)
tran_stres_poduzorkovan = downsample(tran_stres, 10)
tran_neutral2_poduzorkovan = downsample(tran_neutral2, 10)


eyeClo_neutral1_1 = eyeClosureX(113*25 : 116*25)
eyeClo_neutral1_2 = eyeClosureX(141*25 : 144*25)
eyeClo_neutral1_3 = eyeClosureX(184*25 : 187*25)
eyeClo_neutral1_4 = eyeClosureX(232*25 : 235*25)
eyeClo_neutral1_5 = eyeClosureX(275*25 : 278*25)
eyeClo_stres_1 = eyeClosureX(303*25 : 306*25)
eyeClo_stres_2 = eyeClosureX(336*25 : 339*25)
eyeClo_stres_3 = eyeClosureX(384*25 : 387*25)
eyeClo_neutral2_1 = eyeClosureX(412*25 : 415*25)
eyeClo_neutral2_2 = eyeClosureX(450*25 : 453*25)
eyeClo_neutral2_3 = eyeClosureX(483*25 : 486*25)
eyeClo_neutral2_4 = eyeClosureX(531*25 : 534*25)
eyeClo_neutral2_5 = eyeClosureX(569*25 : 572*25)
...
eyeClo_neutral1_poduzorkovan = downsample(eyeClo_neutral1, 10)
eyeClo_stres_poduzorkovan = downsample(eyeClo_stres, 10)
eyeClo_neutral2_poduzorkovan = downsample(eyeClo_neutral2, 10)
