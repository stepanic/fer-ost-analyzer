...
v6_3_1MAX = find5pointsMAX(jL_s_1, findIndex01(vB_s_1));
v6_3_2MAX = find5pointsMAX(jL_s_2, findIndex01(vB_s_2));
v6_3_3MAX = find5pointsMAX(jL_s_3, findIndex01(vB_s_3));

v6_3_1MEAN = find5pointsMEAN(jL_s_1, findIndex01(vB_s_1));
v6_3_2MEAN = find5pointsMEAN(jL_s_2, findIndex01(vB_s_2));
v6_3_3MEAN = find5pointsMEAN(jL_s_3, findIndex01(vB_s_3));
