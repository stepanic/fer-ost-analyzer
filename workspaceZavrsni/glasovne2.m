...
jL_b1_2_0 = jL_b1_2(~isnan(F0_b1_2));
jL_b1_2(isnan(F0_b1_2)) = NaN;
% neutral_1
...
jL_n1_2_0 = jL_n1_2(~isnan(F0_n1_2));
jL_n1_2(isnan(F0_n1_2)) = NaN;
% stres
...
jL_s_2_0 = jL_s_2(~isnan(F0_s_2));
jL_s_2(isnan(F0_s_2)) = NaN;
% neutral_2
...
jL_n2_2_0 = jL_n2_2(~isnan(F0_n2_2));
jL_n2_2(isnan(F0_n2_2)) = NaN;
% baseline_2
tmp = floor(100*(indexParser(83,ts)-0.19));
jL_b2_2 = jL(tmp : tmp + 1000);
jL_b2_2_0 = jL_b2_2(~isnan(F0_b2_2));
jL_b2_2(isnan(F0_b2_2)) = NaN;
