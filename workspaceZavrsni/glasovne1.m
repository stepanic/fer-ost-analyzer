...
F0_n2_2_0 = F0_n2_2(F0_n2_2>0);
F0_n2_2(F0_n2_2 == 0) = NaN;
% baseline_2
tmp = floor(100*(indexParser(83,ts)-0.19));
F0_b2_2 = F0(tmp : tmp + 1000);
F0_b2_2_0 = F0_b2_2(F0_b2_2>0);
F0_b2_2(F0_b2_2 == 0) = NaN;


glasovneAllData = allDataGenerator(F0_b1_2_0,F0_n1_2_0,F0_s_2_0,F0_n2_2_0,F0_b2_2_0);
